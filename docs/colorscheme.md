...
Notice that you can only specify "fg" or "bg" to one colorscheme type, but "normal", "menu", "sidbar", "statusline" should have both.

Below is a truecolor colorscheme example, all colorscheme type is showed.

You can check `resource/colorscheme.json` to have look at all provided colorscheme.
